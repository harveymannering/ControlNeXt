...
class StableDiffusionControlNeXtPipeline(
    ...
    def check_inputs(
        ...
        controlnext_conditioning_scale=1.0,
    ...
    def prepare_image(
        ...
        image = torch.tensor(np.array(image)).to(dtype=torch.float32) / 255.0
    ...
    def __call__(
        ...
        controlnext_conditioning_scale: Union[float, List[float]] = 1.0,
        ...
        **kwargs,
        ...
        self.check_inputs(
            ...
            controlnext_conditioning_scale,
        ...
        # 4. Prepare image
        if isinstance(controlnext, ControlNeXtModel):
